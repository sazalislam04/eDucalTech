...
const About = () => {
  return (
    <ul className="p-4 lg:p-8 text-gray-800 bg-gray-100" data-aos="zoom-in">
      <li>
        <article>
          <Link
            rel="noopener noreferrer"
            to=""
            className="grid p-4 overflow-hidden md:grid-cols-5 rounded-xl lg:p-6 xl:grid-cols-12 hover:bg-gray-900 hover:text-gray-100 transition duration-300"
          >
