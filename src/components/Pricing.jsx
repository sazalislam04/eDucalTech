    ...
    <section className="py-20 bg-gray-100 text-gray-800">
      <div className="container px-4 mx-auto">
        ...
        <div className="flex flex-wrap items-stretch -mx-4">
          ...
          >
            <div className="flex flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-gray-900 text-white">
          ...
          <div
            ...
            data-aos-offset="0"
          >
            <div className="p-6 space-y-6 rounded shadow sm:p-8 bg-gray-900 text-white">
              <div className="space-y-2">
