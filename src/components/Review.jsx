...
const Review = () => {
  ...
  return (
    <div className="container shadow-md mt-20 flex flex-col w-full max-w-lg p-6 mx-auto divide-y rounded-md divide-gray-700 dark:bg-gray-900 dark:text-gray-100">
